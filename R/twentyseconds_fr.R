#' Twenty Seconds CV template - French Version
#'
...
#'
#' @export
twentyseconds_fr <- function(...) {
  template <- system.file("rmarkdown", "templates", "twentyseconds_fr",
                          "resources", "twentyseconds_frtemplate.tex",
                          package = "vitae"
  )
  set_entry_formats(twentyseconds_cv_entries)
  copy_supporting_files("twentyseconds_fr")
